...
| Regular Signature by advance post totals £4.94; domain tests unchanged and green                                          | Yes. The later pricing reconciliation (`docs/pricing-audit.md`) changed the domain tests where the specification differed from the code                                                                          |
...
| Prices match section 5; the editor shows the full price and the Moonpig comparison                                    | Verified by table-driven unit tests against `docs/pricing.md` (£4.94 against £5.89, contributions 1.24/1.93/3.33, pick-up £1.95) and e2e. See `docs/pricing-audit.md`.                                                                                                         |
